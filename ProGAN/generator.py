...
class Eqlr_Conv(nn.Module):
    def __init__(self, in_channel, out_channel, kernal_size=3, padding=1) -> None:
        ...
        self.conv = nn.Conv2d(in_channel, out_channel, kernal_size, padding=padding)
